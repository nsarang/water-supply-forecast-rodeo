...
def train_catboost(
    ...
    **override_params
    ...
    model = Vector(
        [
            CatBoostModelWrapper(cb.CatBoostRegressor(**params, loss_function="Quantile:alpha=0.1")),
            CatBoostModelWrapper(cb.CatBoostRegressor(**params, loss_function="MAE")),
            CatBoostModelWrapper(cb.CatBoostRegressor(**params, loss_function="Quantile:alpha=0.9")),
        ]
    )
